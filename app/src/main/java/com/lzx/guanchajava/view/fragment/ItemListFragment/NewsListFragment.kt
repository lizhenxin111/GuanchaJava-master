...
class NewsListFragment : BaseListFragment<NewsListAdapter>()  {
    ...
    private val onTagClickObj = object : INewsType.OnClickListener {
        ...
        override fun onClick(id: String, type: String) {
            if (type == "1") JumpUtil.startActivity(this@NewsListFragment.activity!!, NewsActivity::class.java, "ID" to id, "CODETYPE" to type)
            else JumpUtil.startActivity(this@NewsListFragment.activity!!, PostActivity::class.java, "ID" to id, "CODETYPE" to type)
        }
    }
