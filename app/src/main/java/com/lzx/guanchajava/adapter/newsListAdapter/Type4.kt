 ...
 * 新闻列表里的风闻
 */
class Type4(override var onClickListener: INewsType.OnClickListener) : INewsType {


    override fun isForViewType(news: News): Boolean {
        return news.show_type == 7
    }


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return Holder(LayoutInflater.from(parent.context).inflate(R.layout.item_type_1, parent, false))
    }
