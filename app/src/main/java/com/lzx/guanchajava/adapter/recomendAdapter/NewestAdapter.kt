...
import com.lzx.guanchajava.adapter.recomendAdapter.NewestAdapter.Holder
import com.lzx.guanchajava.view.widget.UrlImageView
import org.jetbrains.anko.find
import org.jetbrains.anko.sdk27.coroutines.onClick
import org.jetbrains.anko.sdk27.coroutines.onLongClick

class NewestAdapter(val onClickListener: OnClickListener) : RecyclerView.Adapter<Holder>() {

    var data = mutableListOf<Newest>()
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.itemView.onClick { onClickListener.onClick(d.id.toString(), d.code_type.toString()) }
    }
